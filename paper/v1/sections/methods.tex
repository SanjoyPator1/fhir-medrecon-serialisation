...
Ollama using 4-bit quantisation (Q4\_K\_M) on an AWS \texttt{g6e.xlarge} instance
...
\begin{tabular}{lrrll}
\toprule
\textbf{Model} & \textbf{Params} & \textbf{Context} & \textbf{Type} & \textbf{Quant.} \\
\midrule
Phi-3.5-mini   & 3.8B  & 128K & Instruct & Q4\_K\_M \\
Mistral-7B     & 7B    & 32K  & Instruct & Q4\_K\_M \\
BioMistral-7B  & 7B    & 32K  & Pretrain & Q4\_K\_M \\
Llama-3.1-8B   & 8B    & 128K & Instruct & Q4\_K\_M \\
Llama-3.3-70B  & 70B   & 128K & Instruct & Q4\_K\_M \\
\bottomrule
\end{tabular}
\caption{Models evaluated. BioMistral is a further-pretrained base model (not
  instruction-tuned), included to test whether domain pretraining alone is sufficient.
